...
Please note that the following is the legend for the graph given above:
RED = Shape of you, GREEN = Despacito, BLUE = Something just like this, CYAN = Humble, VIOLET = Unforgettable
